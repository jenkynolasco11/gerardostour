...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(98), __webpack_require__(345)(module)))
...
var LoginForm = function (_Component) {
  ...
  _createClass(LoginForm, [{
    ...
    value: function onChange(e, which) {
      ...
      if (which === 'u') username = e.target.value;else password = e.target.value;

      return this.setState({ password: password, username: username });
    }
  }, {
    key: 'onSubmit',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(evnt) {
        var _state2, username, password, self, inputs, error, _ref2, data;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                error = function error(errorMessage) {
                  self.setState({ errorMessage: errorMessage, isError: true });
                  return setTimeout(function () {
                    return self.setState({ errorMessage: '', isError: false });
                  }, 5000);
                };

                evnt.preventDefault();
                _state2 = this.state, username = _state2.username, password = _state2.password;
                self = this;
                ...
                _context.prev = 5;
                _context.next = 8;
                return _axios2.default.post('/admin/auth/login', inputs);
              ...
              case 8:
                ...
                return _context.abrupt('return', window.location.href += '/admin/auth');

              case 12:
                return _context.abrupt('return', error(data.msg));

              case 15:
                _context.prev = 15;
                _context.t0 = _context['catch'](5);
                return _context.abrupt('return', error('Error at the server. Please try again later.'));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'form',
        { className: 'login' },
        _react2.default.createElement('input', { name: 'username', onChange: function onChange(e) {
            return _this2.onChange(e, 'u');
          }, placeholder: 'Username', type: 'text', value: username }),
        _react2.default.createElement('input', { name: 'password', onChange: function onChange(e) {
            return _this2.onChange(e, 'p');
          }, placeholder: 'Password', type: 'password', value: password }),
        _react2.default.createElement('input', { type: 'submit', value: 'Login', onClick: this.onSubmit }),
...
(0, _reactDom.render)(_react2.default.createElement(LoginForm, null), main);
...
var aa = __webpack_require__(94),
    m = __webpack_require__(134),
    A = __webpack_require__(66),
    B = __webpack_require__(48),
    ca = __webpack_require__(135),
    da = __webpack_require__(136),
    ea = __webpack_require__(137),
    ha = __webpack_require__(138),
    ia = __webpack_require__(139),
    C = __webpack_require__(67);
function D(a) {
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(94);var invariant=__webpack_require__(95);var warning=__webpack_require__(96);var ExecutionEnvironment=__webpack_require__(134);var _assign=__webpack_require__(66);var emptyFunction$1=__webpack_require__(48);var EventListener=__webpack_require__(135);var getActiveElement=__webpack_require__(136);var shallowEqual=__webpack_require__(137);var containsNode=__webpack_require__(138);var focusNode=__webpack_require__(139);var emptyObject=__webpack_require__(67);var checkPropTypes=__webpack_require__(133);var hyphenateStyleName=__webpack_require__(358);var camelizeStyleName=__webpack_require__(360);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var defaults = __webpack_require__(97);
var isAbsoluteURL = __webpack_require__(377);
var combineURLs = __webpack_require__(378);
